...
const personSeedData = [
  ...
  },
  {
    ...
    summary:
      'ジェフ・ベゾスは、短期的な収益よりも長期的な成長と顧客価値を優先する思考で知られる経営者で、既存産業をインターネットで再設計し、書店から始まったAmazonを巨大なテクノロジー企業へ育てた。彼の特徴は、顧客から逆算して考える姿勢、仕組み化への執着、そして小さな実験を積み重ねる文化づくりにあり、事業を単なる小売で終わらせず、物流、クラウド、デバイスへと広げた点にも、その長期思考が表れている。',
    career:
